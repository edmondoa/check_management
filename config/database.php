...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'slave' => [
           'driver' => 'mysql',
            'host' => env('SLAVE_DB_HOST', 'localhost'),
            'port' => env('SLAVE_DB_PORT', '3306'),
            'database' => '',
            'username' => env('SLAVE_DB_USERNAME', 'root'),
        ...
        'mysql-live' => [
            ...
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'sis_system'),
            'username' => env('DB_USERNAME', 'root'),
            'password' => env('DB_PASSWORD', 'sispassword1234'),
            'charset' => 'utf8',
            'collation' => 'utf8_unicode_ci',
            'prefix' => '',
            'strict' => false,
