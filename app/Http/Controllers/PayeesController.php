...
class PayeesController extends Controller
{
    ...
    public function payeeList(Request $req)
    {
        ...
        $action = "<div class='text-center'><a data-id='".$row['payee_id']."' href='javascript:void(0)' title='Edit Account' class='payee-edit'><i class='fa fa-pencil-square-o' aria-hidden='true'>edit</i></i></a>";
        $action .= "</div>";
        return [
            'action' => $action,
