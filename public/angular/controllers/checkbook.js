(function(app) {
  ...
  app.controller('checkBookCtrl', ['checkBookService','$scope', function (service,$scope) {
      ...
      this.filterRecord = function(model)
      {
        ...
        var url = '/checkbooks/ng-checkbook-list?searchStr='+searchStr;
        bsTable.bootstrapTable('refresh', {url: url});
      }

      this.saveCheckBook= function(model){   
        service.saveCheckBook(model).then(function (result) {
